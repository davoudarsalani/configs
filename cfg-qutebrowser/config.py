...
config.bind("xd", "hint links spawn xfce4-terminal -e torsocks youtube-dl --external-downloader wget -f 22 {hint-url}")

# play youtube video externally
config.bind("xp", "hint links spawn vlc {hint-url}")

config.set("statusbar.show", "never")
config.set("tabs.show", "never")

# toggle tabs and statusbar
config.bind("xs", "config-cycle statusbar.show always never;; config-cycle tabs.show always never")
