function! SurroundSelection(before_str, ...) range
    ...
    try
        exe 'normal! a'.a:before_str[1]
        " ^^ orig: exe 'normal! a'.a:1
    catch
        exe 'normal! a'.a:before_str[0]
        " ^^ orig: exe 'normal! a'.a:before_str
    endtry
    cal cursor(lnum1, col1)
    exe 'normal! i'.a:before_str[0]
    " ^^ orig: exe 'normal! i'.a:before_str
endfunction
...
function! SurroundWord(before_str, ...)
    ...
    try
        exe l:insert_after.a:before_str[1]
        " ^^ orig: exe l:insert_after.a:1
    catch
        exe l:insert_after.a:before_str[0]
        " ^^ orig: exe l:insert_after.a:before_str
    endtry
    cal cursor(s:cursorpos)
    exe 'normal! lbi'.a:before_str[0]
    " ^^ orig: exe 'normal! lbi'.a:before_str
endfunction
