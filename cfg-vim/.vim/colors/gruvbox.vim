...
let s:gb.background  = ['#1d2021', 0]
let s:gb.fg          = ['#ebdbb2', 7]  " by me
...
let s:gb.gray_243    = ['#928374', 243]
let s:gb.gray_242    = ['#928374', 242]
let s:gb.gray_241    = ['#928374', 241]
let s:gb.gray_240    = ['#928374', 240]

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#fbf1c7', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#ebdbb2', 255]     " text fg
...
let s:gb.todo           = ['#d3869b', 246]
let s:gb.bright_aqua    = ['#8ec07c', 107]     " 142-92-124    orig 108
...
let s:gb.faded_blue     = ['#076678', 67]       " 7-102-120  orig 24
...
call s:HL('GruvboxYellowCream', s:gb.cream_yellow)  " by me

call s:HL('GruvboxBlue', s:blue)
call s:HL('GruvboxBlueBold', s:blue, s:none, s:bold)
call s:HL('GruvboxBlueNeutral', s:gb.neutral_blue)  " by me
call s:HL('GruvboxBlueFaded', s:gb.faded_blue)  " by me


call s:HL('GruvboxPurple', s:purple)
call s:HL('GruvboxPurpleBold', s:purple, s:none, s:bold)
call s:HL('GruvboxPurpleNeutral', s:gb.neutral_purple)  " by me

call s:HL('GruvboxAqua', s:aqua)
call s:HL('GruvboxAquaNeutral', s:gb.neutral_aqua)  " by me
...
" Normal text
call s:HL('Normal', s:gb.fg, s:bg0)
                    " ^-- orig s:fg1 !
...
let s:gb.match_parenthesis_bg = ['#7c6f64', 234]
let s:gb.match_parenthesis_fg = s:gb.neutral_blue  " ['#7c6f64', 4]
  call s:HL('MatchParen', s:gb.match_parenthesis_fg, s:none) " orig: call s:HL('MatchParen', s:gb.match_parenthesis_fg, s:gb.match_parenthesis_bg, s:bold)
endif
...
let s:gb.select_fg = ['#7c6f64', 16]
let s:gb.select_bg = ['#7c6f64', 11]
call s:HL('Visual', s:gb.select_fg, s:gb.select_bg, s:italic)

hi! link VisualNOS Visual

let s:gb.search_fg = ['#7c6f64', 2]
let s:gb.search_bg = ['#7c6f64', 0]
call s:HL('Search',    s:gb.search_fg, s:gb.search_bg, s:italic)
call s:HL('IncSearch', s:gb.search_fg, s:gb.search_bg, s:italic)

let s:gb.yankedtext_fg = ['#7c6f64', 16]
let s:gb.yankedtext_bg = ['#7c6f64', 4]
" call s:HL('YankedText', s:gb.yankedtext_fg, s:gb.yankedtext_bg, s:italic)
call s:HL('YankedText', s:none, s:none, s:italic)
...
call s:HL('ErrorMsg', s:gb.neutral_red, s:none, s:bold)

" More prompt: -- More --
hi! link MoreMsg GruvboxYellow
" Current mode message: -- INSERT --
hi! link ModeMsg GruvboxOrange
" 'Press enter' prompt and yes/no questions
hi! link Question GruvboxYellowBold
" Warning messages
...
call s:HL('Folded', s:gb.fold_fg, s:none)
...
call s:HL('Todo', s:todo, s:none, s:bold . s:italic)
...
" struct, union, enum, int, etc.
hi! link Structure GruvboxAquaNeutral
                     " ^ orig GruvboxAqua
" typedef
...
if version >= 700
  ...
  call s:HL('PmenuThumb', s:none, s:gb.pmenu_scr_fg)
endif
" }}}
" Diffs: {{{
...
" let s:gb.easymotion_fg = ['#7c6f64', 2]
" call s:HL('EASYMOTION', s:gb.easymotion_fg, s:none, s:italic)
" hi! link EasyMotionTarget EASYMOTION
" hi! link EasyMotionShade  Comment
" }}}
" Sneak: {{{
...
" }}}
" Signature: {{{
hi! link SignatureMarkText   GruvboxGreen
...
hi! link pythonOperator    GruvboxPurpleNeutral
...
hi! link pythonFunction    GruvboxBlueNeutral
hi! link pythonDottedName  GruvboxBlue
" vv my me
hi! link PythonParams      GruvboxBlueFaded
hi! link PythonVars        GruvboxYellowCream
" }}}
" Diff: {{{
