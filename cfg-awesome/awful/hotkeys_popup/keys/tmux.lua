  ...
  ['z  vim'] = {
    {
      ...
      keys = {
               ...
               ['`']                    = create_description(vim_kb_fg, "<span color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[fzf]</span> :Marks"),
               ['::']                   = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[fzf]</span> :History:"),
               [';;']                   = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[fzf]</span> :History:"),
               ['//']                   = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[fzf]</span> :History/"),
    ...
    },
    {
      modifiers = {'Ctrl'},
      keys = {
               l            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'></span> <span color='" .. plugin_fg .. "'>[fzf]</span> :BLines"),
               ...
               x            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[multicursor]</span> skip match, <span color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[CtrlXA]</span> cycle through lists of keywords"),
               ...
               ['\\']       = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'></span> <span color='" .. plugin_fg .. "'>[fzf]</span> :Maps"),
             }
    },
    {
      modifiers = {'Alt'},
      keys = {
               d            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> diff"),
               f            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> fold unchanged lines"),
               h            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> hunk diff"),
               j            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> next hunk"),
               k            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> prev hunk"),
               r            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> refresh"),
               t            = create_description(vim_kb_fg, "<span    color='" .. mode_fg .. "'>N</span> <span color='" .. plugin_fg .. "'>[signify]</span> toggle"),
